...
const Gallery = ({ photos, addToCart, removeFromCart, cart, openModal, tags, searchValue, setSearchValue }) => {
  return (
    <div className='container container--main-wrap'>
      <main className='gallery pt-4 pb-5'>
        ...
        <Navbar tags={tags} searchValue={searchValue} setSearchValue={setSearchValue}/>
